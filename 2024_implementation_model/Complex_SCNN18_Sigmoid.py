...
class Complex_SCNN18_Sigmoid(Model):

    def __init__(self, input_shape, nb_classes, **kwargs):
        super(Complex_SCNN18_Sigmoid, self).__init__(**kwargs)
        ...
        # self.square_lambda = klayers.Lambda(K.square, name='square')
        # self.sqrt_lambda = klayers.Lambda(K.sqrt, name='sqrt')
        # self.final_bn = klayers.BatchNormalization(name='final_bn')
        # self.out_dense = klayers.Dense(nb_classes, name="Dense_2nb_sigmoid", activation='sigmoid')
        self.out_dense1 = klayers.Dense(nb_classes, name="Dense_2nb_sigmoid_1", activation='sigmoid')
        self.out_dense2 = klayers.Dense(nb_classes, name="Dense_2nb_sigmoid_2", activation='sigmoid')
    ...
    def call(self, x, **kwargs):
        ...
        # x = klayers.add((self.square_lambda(real), self.square_lambda(imag)))
