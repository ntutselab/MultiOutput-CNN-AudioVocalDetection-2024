...
from models.Layers import STSA_fourSecond, USCLLayer


class SCNN18_Sigmoid_fourSecond(Model):

    def __init__(self, input_shape, nb_classes, **kwargs):
        super(SCNN18_Sigmoid_fourSecond, self).__init__(**kwargs)

        self.input_layer = klayers.Input(input_shape, name='input')

        self.STSA = STSA_fourSecond()
