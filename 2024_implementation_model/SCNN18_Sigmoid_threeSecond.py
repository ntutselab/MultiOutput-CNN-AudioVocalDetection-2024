...
from models.Layers import STSA_threeSecond, USCLLayer


class SCNN18_Sigmoid_threeSecond(Model):

    def __init__(self, input_shape, nb_classes, **kwargs):
        super(SCNN18_Sigmoid_threeSecond, self).__init__(**kwargs)

        self.input_layer = klayers.Input(input_shape, name='input')

        self.STSA = STSA_threeSecond()
        ...
        self.final_pool = klayers.MaxPool2D((3, 2), padding='same')
