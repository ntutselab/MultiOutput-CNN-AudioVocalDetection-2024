...
class SCNN18_Sigmoid_First4Modified(Model):

    def __init__(self, input_shape, nb_classes, **kwargs):
        super(SCNN18_Sigmoid_First4Modified, self).__init__(**kwargs)

        self.input_layer = klayers.Input(input_shape, name='input')

        self.STSA = STSA()

        self.uscl_conv1 = USCLLayer(64, (3, 2), (1, 2), False, 'same', 1, name='uscl_conv1')
        ...
        self.uscl_conv5 = USCLLayer(64, (1, 2), (3, 1), True, 'same', 5, name='uscl_conv5')
