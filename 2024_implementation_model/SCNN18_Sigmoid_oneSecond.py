...
from models.Layers import STSA_OneSecond, USCLLayer


class SCNN18_Sigmoid(Model):

    def __init__(self, input_shape, nb_classes, **kwargs):
        super(SCNN18_Sigmoid, self).__init__(**kwargs)

        self.input_layer = klayers.Input(input_shape, name='input')

        self.STSA = STSA_OneSecond()
        ...
        self.final_pool = klayers.MaxPool2D((3, 1))
