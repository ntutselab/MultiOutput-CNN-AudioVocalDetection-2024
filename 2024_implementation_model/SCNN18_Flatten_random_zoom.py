...
class SCNN18_Flatten_random_zoom(Model):

    def __init__(self, input_shape, **kwargs):
        super(SCNN18_Flatten_random_zoom, self).__init__(**kwargs)
        ...
        # Augmentation layers
        self.zoom = RandomZoom(height_factor=(-0.2, 0.2), width_factor=(-0.2, 0.2), fill_mode='reflect', name="random_zoom")
